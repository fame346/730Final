...
public class AbstractClass {
		public static void main(String [] args) {
			...
			Ships.add(STShip1);Ships.add(STShip2);Ships.add(STShip3);Ships.add(SWShip1);
			Ships.add(SWShip2);Ships.add(SWShip3);Ships.add(WHShip1);Ships.add(WHShip2);Ships.add(WHShip3);
